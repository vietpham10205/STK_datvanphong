...
public class PhongTam {
    ...
    public static void setLocationName(String locationName) {
        PhongTam.locationName = locationName;
    }

    public static void setAll(String tenPhong, String diaChi, String moTa, int sucChua, double gia, double dienTich, int roomTypeId, int locationId, String locationName) {
        PhongTam.tenPhong = tenPhong;
        PhongTam.diaChi = diaChi;
        PhongTam.moTa = moTa;
        PhongTam.sucChua = sucChua;
